...
Če bi imel napadalec na voljo naprednejšo strojno opremo, kot je \texttt{Ubertooth One}, bi lahko prisluškoval (sniffal) Bluetooth komunikacijo in posnel MAC naslov naprave, ki ji telefon že zaupa. Nato bi se lahko predstavljal kot ta naprava (MAC address spoofing) in s tem izvedel enake ukaze, ne da bi bilo potrebno kakršno koli predhodno seznanjanje – telefon bi namreč povezavo sprejel, ker bi verjel, da komunicira z že znano in zaupano napravo.
...
\begin{itemize}
	\item Ranljivost CVE-2023-45866 omogoča injiciranje tipk na vseh novejših Android napravah (Bluetooth 4.2 in novejši), ki niso bile popravljene. Napad poteka popolnoma brez interakcije uporabnika – žrtev ne vidi nobenega obvestila o parjenju ali povezovanju.
	\item Čeprav je bilo za prvo povezavo včasih treba potrditi dovoljenje za seznanitev (pairing), bi to oviro lahko zaobšli z uporabo naprednejše strojne opreme, kot je \texttt{Ubertooth One}. S slednjo bi lahko ponaredili (spoofali) MAC naslov naprave, ki ji telefon že zaupa, in se tako predstavljali kot že prej potrjena naprava.
	\item Starejše naprave (Bluetooth 3.0 in nižje) praviloma niso ranljive za ta napad, ker ne podpirajo HID profila prek Bluetootha oziroma nimajo dovolj odprtih storitev, prek katerih bi lahko vzpostavili takšno povezavo.
\end{itemize}

Napad CVE-2023-45866 tako predstavlja resno varnostno tveganje za vse neposodobljene Android naprave, saj napadalcu omogoča popoln nadzor nad vnosom tipk – od odpiranja zlonamernih spletnih strani do izvajanja sistemskih ukazov.
