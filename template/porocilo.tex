...
Na sliki \ref{fig:heatmap} je prikazana toplotna karta (angl. heatmap) jakosti signala v prostoru dimenzij 3 × 3,5 m. Dostopna točka se nahaja na mestu A3. Opazimo, da je signal najmočnejši v njeni bližini ter postopoma slabi z naraščajočo oddaljenostjo. Na porazdelitev moči pomembno vplivajo tudi ovire in odboji od sten, kar se kaže v območjih z nenadnimi padci signala.
\begin{figure}[H]
	\centering
...
Ta ukaz je precej podoben prejšnjemu za razliko od večjega števila paketov in dodatno zastavico -f, ki pomeni flood (pošlji pakete brez zakasnitve). Tukaj je tudi računanje povprečja precej nadležno, saj \texttt{l2ping} ne sam izpisuje teh podatkov zato sem si pomagal z naslednjim pyhon programom:
\begin{minted}[
	linenos,
	frame=lines,
	framesep=6pt,
...
Napisal sem 2 bolj enostavna skripta za Rubber ducky in uporabil malo prilagojeno kodo BlueDucky~\cite{blueducky, cve2023-45866} en od teh skriptov je bolj satiričen in sicer predvaja pesem Rick Astley - Never gonna give you up, drugi pa gre v nastavitve telefona.
...
\end{verbatim}
Seveda ukaz kot je \texttt{GUI i} je na vsakem telefonu bil drugačen. Ta specifičen skript je napisan za OPPO Find X5, pri katerem je sistemski jezik v italjanščini.
...
Ta napad je zelo podoben prejšnjemu napadu in bi ga tudi štel pod denial of service, ampak bi mu rad dal dodatno pozornost. V tem delu bom uporabljal posebno opremo in sicer \texttt{Flipper zero} uporabil pa ga bom da zamrznem iPhone napravo (iPhone 8). 
\begin{figure}[H]
	\centering
